...
pytest_cov:
	...
	$(TEST) -v --cov-report=html:./assignments/A6-inheritance/statistics/coverage_report --cov-report=term --cov=./assignments/A6-inheritance/statistics/ ./assignments/A6-inheritance/statistics/tests
